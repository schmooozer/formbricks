...
const preboardingSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.preboarding_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.preboarding_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.preboarding_survey_question_1_headline"),
              lowerLabel: t("templates.preboarding_survey_question_1_lower_label"),
              upperLabel: t("templates.preboarding_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.preboarding_survey_question_2_headline"),
              lowerLabel: t("templates.preboarding_survey_question_2_lower_label"),
              upperLabel: t("templates.preboarding_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.preboarding_survey_question_3_headline"),
              lowerLabel: t("templates.preboarding_survey_question_3_lower_label"),
              upperLabel: t("templates.preboarding_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.preboarding_survey_question_4_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.preboarding_survey_question_4_choice_1"),
                t("templates.preboarding_survey_question_4_choice_2"),
                t("templates.preboarding_survey_question_4_choice_3"),
                t("templates.preboarding_survey_question_4_choice_4"),
                t("templates.preboarding_survey_question_4_choice_5"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.preboarding_survey_question_5_headline"),
              required: false,
              inputType: "text",
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.preboarding_survey_question_6_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const dayOneFirstDaySurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.day_one_first_day_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.day_one_first_day_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.day_one_first_day_survey_question_1_headline"),
              lowerLabel: t("templates.day_one_first_day_survey_question_1_lower_label"),
              upperLabel: t("templates.day_one_first_day_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.day_one_first_day_survey_question_2_headline"),
              lowerLabel: t("templates.day_one_first_day_survey_question_2_lower_label"),
              upperLabel: t("templates.day_one_first_day_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.day_one_first_day_survey_question_3_headline"),
              lowerLabel: t("templates.day_one_first_day_survey_question_3_lower_label"),
              upperLabel: t("templates.day_one_first_day_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.day_one_first_day_survey_question_4_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.day_one_first_day_survey_question_4_choice_1"),
                t("templates.day_one_first_day_survey_question_4_choice_2"),
                t("templates.day_one_first_day_survey_question_4_choice_3"),
                t("templates.day_one_first_day_survey_question_4_choice_4"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.day_one_first_day_survey_question_5_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const onboarding7DaySurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.onboarding_7_day_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.onboarding_7_day_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.onboarding_7_day_survey_question_1_headline"),
              lowerLabel: t("templates.onboarding_7_day_survey_question_1_lower_label"),
              upperLabel: t("templates.onboarding_7_day_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.onboarding_7_day_survey_question_2_headline"),
              lowerLabel: t("templates.onboarding_7_day_survey_question_2_lower_label"),
              upperLabel: t("templates.onboarding_7_day_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.onboarding_7_day_survey_question_3_headline"),
              lowerLabel: t("templates.onboarding_7_day_survey_question_3_lower_label"),
              upperLabel: t("templates.onboarding_7_day_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.onboarding_7_day_survey_question_4_headline"),
              lowerLabel: t("templates.onboarding_7_day_survey_question_4_lower_label"),
              upperLabel: t("templates.onboarding_7_day_survey_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.onboarding_7_day_survey_question_5_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.onboarding_7_day_survey_question_5_choice_1"),
                t("templates.onboarding_7_day_survey_question_5_choice_2"),
                t("templates.onboarding_7_day_survey_question_5_choice_3"),
                t("templates.onboarding_7_day_survey_question_5_choice_4"),
                t("templates.onboarding_7_day_survey_question_5_choice_5"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.onboarding_7_day_survey_question_6_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const sixMonthNewHireCheckIn = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.six_month_new_hire_check_in_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.six_month_new_hire_check_in_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.six_month_new_hire_check_in_question_1_headline"),
              lowerLabel: t("templates.six_month_new_hire_check_in_question_1_lower_label"),
              upperLabel: t("templates.six_month_new_hire_check_in_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.six_month_new_hire_check_in_question_2_headline"),
              lowerLabel: t("templates.six_month_new_hire_check_in_question_2_lower_label"),
              upperLabel: t("templates.six_month_new_hire_check_in_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.six_month_new_hire_check_in_question_3_headline"),
              lowerLabel: t("templates.six_month_new_hire_check_in_question_3_lower_label"),
              upperLabel: t("templates.six_month_new_hire_check_in_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.six_month_new_hire_check_in_question_4_headline"),
              lowerLabel: t("templates.six_month_new_hire_check_in_question_4_lower_label"),
              upperLabel: t("templates.six_month_new_hire_check_in_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.six_month_new_hire_check_in_question_5_headline"),
              lowerLabel: t("templates.six_month_new_hire_check_in_question_5_lower_label"),
              upperLabel: t("templates.six_month_new_hire_check_in_question_5_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.six_month_new_hire_check_in_question_6_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.six_month_new_hire_check_in_question_6_choice_1"),
                t("templates.six_month_new_hire_check_in_question_6_choice_2"),
                t("templates.six_month_new_hire_check_in_question_6_choice_3"),
                t("templates.six_month_new_hire_check_in_question_6_choice_4"),
                t("templates.six_month_new_hire_check_in_question_6_choice_5"),
                t("templates.six_month_new_hire_check_in_question_6_choice_6"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.six_month_new_hire_check_in_question_7_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const probationEndSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.probation_end_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.probation_end_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.probation_end_survey_question_1_headline"),
              lowerLabel: t("templates.probation_end_survey_question_1_lower_label"),
              upperLabel: t("templates.probation_end_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.probation_end_survey_question_2_headline"),
              lowerLabel: t("templates.probation_end_survey_question_2_lower_label"),
              upperLabel: t("templates.probation_end_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.probation_end_survey_question_3_headline"),
              lowerLabel: t("templates.probation_end_survey_question_3_lower_label"),
              upperLabel: t("templates.probation_end_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.probation_end_survey_question_4_headline"),
              lowerLabel: t("templates.probation_end_survey_question_4_lower_label"),
              upperLabel: t("templates.probation_end_survey_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.probation_end_survey_question_5_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.probation_end_survey_question_5_choice_1"),
                t("templates.probation_end_survey_question_5_choice_2"),
                t("templates.probation_end_survey_question_5_choice_3"),
                t("templates.probation_end_survey_question_5_choice_4"),
                t("templates.probation_end_survey_question_5_choice_5"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.probation_end_survey_question_6_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const anniversarySurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.anniversary_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.anniversary_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.anniversary_survey_question_1_headline"),
              lowerLabel: t("templates.anniversary_survey_question_1_lower_label"),
              upperLabel: t("templates.anniversary_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.anniversary_survey_question_2_headline"),
              lowerLabel: t("templates.anniversary_survey_question_2_lower_label"),
              upperLabel: t("templates.anniversary_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.anniversary_survey_question_3_headline"),
              lowerLabel: t("templates.anniversary_survey_question_3_lower_label"),
              upperLabel: t("templates.anniversary_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.anniversary_survey_question_4_headline"),
              lowerLabel: t("templates.anniversary_survey_question_4_lower_label"),
              upperLabel: t("templates.anniversary_survey_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildNPSElement({
              headline: t("templates.anniversary_survey_question_5_headline"),
              required: true,
              lowerLabel: t("templates.anniversary_survey_question_5_lower_label"),
              upperLabel: t("templates.anniversary_survey_question_5_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.anniversary_survey_question_6_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.anniversary_survey_question_6_choice_1"),
                t("templates.anniversary_survey_question_6_choice_2"),
                t("templates.anniversary_survey_question_6_choice_3"),
                t("templates.anniversary_survey_question_6_choice_4"),
                t("templates.anniversary_survey_question_6_choice_5"),
                t("templates.anniversary_survey_question_6_choice_6"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.anniversary_survey_question_7_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const promotionSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.promotion_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.promotion_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.promotion_survey_question_1_headline"),
              lowerLabel: t("templates.promotion_survey_question_1_lower_label"),
              upperLabel: t("templates.promotion_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.promotion_survey_question_2_headline"),
              lowerLabel: t("templates.promotion_survey_question_2_lower_label"),
              upperLabel: t("templates.promotion_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.promotion_survey_question_3_headline"),
              lowerLabel: t("templates.promotion_survey_question_3_lower_label"),
              upperLabel: t("templates.promotion_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.promotion_survey_question_4_headline"),
              lowerLabel: t("templates.promotion_survey_question_4_lower_label"),
              upperLabel: t("templates.promotion_survey_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.promotion_survey_question_5_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.promotion_survey_question_5_choice_1"),
                t("templates.promotion_survey_question_5_choice_2"),
                t("templates.promotion_survey_question_5_choice_3"),
                t("templates.promotion_survey_question_5_choice_4"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.promotion_survey_question_6_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const internalTransferSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.internal_transfer_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.internal_transfer_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.internal_transfer_survey_question_1_headline"),
              lowerLabel: t("templates.internal_transfer_survey_question_1_lower_label"),
              upperLabel: t("templates.internal_transfer_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.internal_transfer_survey_question_2_headline"),
              lowerLabel: t("templates.internal_transfer_survey_question_2_lower_label"),
              upperLabel: t("templates.internal_transfer_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.internal_transfer_survey_question_3_headline"),
              lowerLabel: t("templates.internal_transfer_survey_question_3_lower_label"),
              upperLabel: t("templates.internal_transfer_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.internal_transfer_survey_question_4_headline"),
              lowerLabel: t("templates.internal_transfer_survey_question_4_lower_label"),
              upperLabel: t("templates.internal_transfer_survey_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.internal_transfer_survey_question_5_headline"),
              lowerLabel: t("templates.internal_transfer_survey_question_5_lower_label"),
              upperLabel: t("templates.internal_transfer_survey_question_5_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.internal_transfer_survey_question_6_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.internal_transfer_survey_question_6_choice_1"),
                t("templates.internal_transfer_survey_question_6_choice_2"),
                t("templates.internal_transfer_survey_question_6_choice_3"),
                t("templates.internal_transfer_survey_question_6_choice_4"),
                t("templates.internal_transfer_survey_question_6_choice_5"),
                t("templates.internal_transfer_survey_question_6_choice_6"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.internal_transfer_survey_question_7_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const returnFromLeaveSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.return_from_leave_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.return_from_leave_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.return_from_leave_survey_question_1_headline"),
              lowerLabel: t("templates.return_from_leave_survey_question_1_lower_label"),
              upperLabel: t("templates.return_from_leave_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.return_from_leave_survey_question_2_headline"),
              lowerLabel: t("templates.return_from_leave_survey_question_2_lower_label"),
              upperLabel: t("templates.return_from_leave_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.return_from_leave_survey_question_3_headline"),
              lowerLabel: t("templates.return_from_leave_survey_question_3_lower_label"),
              upperLabel: t("templates.return_from_leave_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.return_from_leave_survey_question_4_headline"),
              lowerLabel: t("templates.return_from_leave_survey_question_4_lower_label"),
              upperLabel: t("templates.return_from_leave_survey_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.return_from_leave_survey_question_5_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.return_from_leave_survey_question_5_choice_1"),
                t("templates.return_from_leave_survey_question_5_choice_2"),
                t("templates.return_from_leave_survey_question_5_choice_3"),
                t("templates.return_from_leave_survey_question_5_choice_4"),
                t("templates.return_from_leave_survey_question_5_choice_5"),
                t("templates.return_from_leave_survey_question_5_choice_6"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.return_from_leave_survey_question_6_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const parentalLeaveSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.parental_leave_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.parental_leave_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.parental_leave_survey_question_1_headline"),
              lowerLabel: t("templates.parental_leave_survey_question_1_lower_label"),
              upperLabel: t("templates.parental_leave_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.parental_leave_survey_question_2_headline"),
              lowerLabel: t("templates.parental_leave_survey_question_2_lower_label"),
              upperLabel: t("templates.parental_leave_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.parental_leave_survey_question_3_headline"),
              lowerLabel: t("templates.parental_leave_survey_question_3_lower_label"),
              upperLabel: t("templates.parental_leave_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.parental_leave_survey_question_4_headline"),
              lowerLabel: t("templates.parental_leave_survey_question_4_lower_label"),
              upperLabel: t("templates.parental_leave_survey_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.parental_leave_survey_question_5_headline"),
              lowerLabel: t("templates.parental_leave_survey_question_5_lower_label"),
              upperLabel: t("templates.parental_leave_survey_question_5_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.parental_leave_survey_question_6_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.parental_leave_survey_question_6_choice_1"),
                t("templates.parental_leave_survey_question_6_choice_2"),
                t("templates.parental_leave_survey_question_6_choice_3"),
                t("templates.parental_leave_survey_question_6_choice_4"),
                t("templates.parental_leave_survey_question_6_choice_5"),
                t("templates.parental_leave_survey_question_6_choice_6"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.parental_leave_survey_question_7_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const alumniSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.alumni_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.alumni_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.alumni_survey_question_1_headline"),
              lowerLabel: t("templates.alumni_survey_question_1_lower_label"),
              upperLabel: t("templates.alumni_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.alumni_survey_question_2_headline"),
              lowerLabel: t("templates.alumni_survey_question_2_lower_label"),
              upperLabel: t("templates.alumni_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.alumni_survey_question_3_headline"),
              lowerLabel: t("templates.alumni_survey_question_3_lower_label"),
              upperLabel: t("templates.alumni_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildNPSElement({
              headline: t("templates.alumni_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.alumni_survey_question_4_lower_label"),
              upperLabel: t("templates.alumni_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.alumni_survey_question_5_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.alumni_survey_question_5_choice_1"),
                t("templates.alumni_survey_question_5_choice_2"),
                t("templates.alumni_survey_question_5_choice_3"),
                t("templates.alumni_survey_question_5_choice_4"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.alumni_survey_question_6_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.alumni_survey_question_6_choice_1"),
                t("templates.alumni_survey_question_6_choice_2"),
                t("templates.alumni_survey_question_6_choice_3"),
                t("templates.alumni_survey_question_6_choice_4"),
                t("templates.alumni_survey_question_6_choice_5"),
                t("templates.alumni_survey_question_6_choice_6"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.alumni_survey_question_7_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const exitInterviewFollowUpSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.exit_interview_follow_up_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.exit_interview_follow_up_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.exit_interview_follow_up_survey_question_1_headline"),
              lowerLabel: t("templates.exit_interview_follow_up_survey_question_1_lower_label"),
              upperLabel: t("templates.exit_interview_follow_up_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.exit_interview_follow_up_survey_question_2_headline"),
              lowerLabel: t("templates.exit_interview_follow_up_survey_question_2_lower_label"),
              upperLabel: t("templates.exit_interview_follow_up_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.exit_interview_follow_up_survey_question_3_headline"),
              lowerLabel: t("templates.exit_interview_follow_up_survey_question_3_lower_label"),
              upperLabel: t("templates.exit_interview_follow_up_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.exit_interview_follow_up_survey_question_4_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.exit_interview_follow_up_survey_question_4_choice_1"),
                t("templates.exit_interview_follow_up_survey_question_4_choice_2"),
                t("templates.exit_interview_follow_up_survey_question_4_choice_3"),
                t("templates.exit_interview_follow_up_survey_question_4_choice_4"),
                t("templates.exit_interview_follow_up_survey_question_4_choice_5"),
                t("templates.exit_interview_follow_up_survey_question_4_choice_6"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.exit_interview_follow_up_survey_question_5_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const retirementTransitionSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.retirement_transition_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.retirement_transition_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.retirement_transition_survey_question_1_headline"),
              lowerLabel: t("templates.retirement_transition_survey_question_1_lower_label"),
              upperLabel: t("templates.retirement_transition_survey_question_1_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.retirement_transition_survey_question_2_headline"),
              lowerLabel: t("templates.retirement_transition_survey_question_2_lower_label"),
              upperLabel: t("templates.retirement_transition_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.retirement_transition_survey_question_3_headline"),
              lowerLabel: t("templates.retirement_transition_survey_question_3_lower_label"),
              upperLabel: t("templates.retirement_transition_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.retirement_transition_survey_question_4_headline"),
              lowerLabel: t("templates.retirement_transition_survey_question_4_lower_label"),
              upperLabel: t("templates.retirement_transition_survey_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.retirement_transition_survey_question_5_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.retirement_transition_survey_question_5_choice_1"),
                t("templates.retirement_transition_survey_question_5_choice_2"),
                t("templates.retirement_transition_survey_question_5_choice_3"),
                t("templates.retirement_transition_survey_question_5_choice_4"),
                t("templates.retirement_transition_survey_question_5_choice_5"),
                t("templates.retirement_transition_survey_question_5_choice_6"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.retirement_transition_survey_question_6_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const offerDeclineSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.offer_decline_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.offer_decline_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              type: TSurveyElementTypeEnum.MultipleChoiceSingle,
              headline: t("templates.offer_decline_survey_question_1_headline"),
              required: true,
              shuffleOption: "none",
              choices: [
                t("templates.offer_decline_survey_question_1_choice_1"),
                t("templates.offer_decline_survey_question_1_choice_2"),
                t("templates.offer_decline_survey_question_1_choice_3"),
                t("templates.offer_decline_survey_question_1_choice_4"),
                t("templates.offer_decline_survey_question_1_choice_5"),
                t("templates.offer_decline_survey_question_1_choice_6"),
                t("templates.offer_decline_survey_question_1_choice_7"),
              ],
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.offer_decline_survey_question_2_headline"),
              lowerLabel: t("templates.offer_decline_survey_question_2_lower_label"),
              upperLabel: t("templates.offer_decline_survey_question_2_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.offer_decline_survey_question_3_headline"),
              lowerLabel: t("templates.offer_decline_survey_question_3_lower_label"),
              upperLabel: t("templates.offer_decline_survey_question_3_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.offer_decline_survey_question_4_headline"),
              lowerLabel: t("templates.offer_decline_survey_question_4_lower_label"),
              upperLabel: t("templates.offer_decline_survey_question_4_upper_label"),
              required: true,
              isColorCodingEnabled: true,
            }),
          ],
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.offer_decline_survey_question_5_headline"),
              required: false,
              inputType: "text",
            }),
          ],
...
const hybridWorkSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.hybrid_work_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.hybrid_work_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.hybrid_work_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.hybrid_work_survey_question_1_lower_label"),
              upperLabel: t("templates.hybrid_work_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.hybrid_work_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.hybrid_work_survey_question_2_lower_label"),
              upperLabel: t("templates.hybrid_work_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.hybrid_work_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.hybrid_work_survey_question_3_lower_label"),
              upperLabel: t("templates.hybrid_work_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.hybrid_work_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.hybrid_work_survey_question_4_lower_label"),
              upperLabel: t("templates.hybrid_work_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              ...
              shuffleOption: "none",
              choices: [
                t("templates.hybrid_work_survey_question_5_choice_1"),
                t("templates.hybrid_work_survey_question_5_choice_2"),
                t("templates.hybrid_work_survey_question_5_choice_3"),
                t("templates.hybrid_work_survey_question_5_choice_4"),
                t("templates.hybrid_work_survey_question_5_choice_5"),
                t("templates.hybrid_work_survey_question_5_choice_6"),
              ],
              headline: t("templates.hybrid_work_survey_question_5_headline"),
              required: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.hybrid_work_survey_question_6_headline"),
              required: false,
              placeholder: t("templates.hybrid_work_survey_question_6_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const remoteWorkSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.remote_work_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.remote_work_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.remote_work_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.remote_work_survey_question_1_lower_label"),
              upperLabel: t("templates.remote_work_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.remote_work_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.remote_work_survey_question_2_lower_label"),
              upperLabel: t("templates.remote_work_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.remote_work_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.remote_work_survey_question_3_lower_label"),
              upperLabel: t("templates.remote_work_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.remote_work_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.remote_work_survey_question_4_lower_label"),
              upperLabel: t("templates.remote_work_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              ...
              shuffleOption: "none",
              choices: [
                t("templates.remote_work_survey_question_5_choice_1"),
                t("templates.remote_work_survey_question_5_choice_2"),
                t("templates.remote_work_survey_question_5_choice_3"),
                t("templates.remote_work_survey_question_5_choice_4"),
                t("templates.remote_work_survey_question_5_choice_5"),
                t("templates.remote_work_survey_question_5_choice_6"),
              ],
              headline: t("templates.remote_work_survey_question_5_headline"),
              required: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.remote_work_survey_question_6_headline"),
              required: false,
              placeholder: t("templates.remote_work_survey_question_6_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const returnToOfficeSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.return_to_office_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.return_to_office_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.return_to_office_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.return_to_office_survey_question_1_lower_label"),
              upperLabel: t("templates.return_to_office_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.return_to_office_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.return_to_office_survey_question_2_lower_label"),
              upperLabel: t("templates.return_to_office_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.return_to_office_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.return_to_office_survey_question_3_lower_label"),
              upperLabel: t("templates.return_to_office_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.return_to_office_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.return_to_office_survey_question_4_lower_label"),
              upperLabel: t("templates.return_to_office_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              ...
              shuffleOption: "none",
              choices: [
                t("templates.return_to_office_survey_question_5_choice_1"),
                t("templates.return_to_office_survey_question_5_choice_2"),
                t("templates.return_to_office_survey_question_5_choice_3"),
                t("templates.return_to_office_survey_question_5_choice_4"),
                t("templates.return_to_office_survey_question_5_choice_5"),
                t("templates.return_to_office_survey_question_5_choice_6"),
              ],
              headline: t("templates.return_to_office_survey_question_5_headline"),
              required: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.return_to_office_survey_question_6_headline"),
              required: false,
              placeholder: t("templates.return_to_office_survey_question_6_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const facilitiesSatisfactionSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.facilities_satisfaction_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.facilities_satisfaction_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.facilities_satisfaction_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.facilities_satisfaction_survey_question_1_lower_label"),
              upperLabel: t("templates.facilities_satisfaction_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.facilities_satisfaction_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.facilities_satisfaction_survey_question_2_lower_label"),
              upperLabel: t("templates.facilities_satisfaction_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.facilities_satisfaction_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.facilities_satisfaction_survey_question_3_lower_label"),
              upperLabel: t("templates.facilities_satisfaction_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.facilities_satisfaction_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.facilities_satisfaction_survey_question_4_lower_label"),
              upperLabel: t("templates.facilities_satisfaction_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              ...
              shuffleOption: "none",
              choices: [
                t("templates.facilities_satisfaction_survey_question_5_choice_1"),
                t("templates.facilities_satisfaction_survey_question_5_choice_2"),
                t("templates.facilities_satisfaction_survey_question_5_choice_3"),
                t("templates.facilities_satisfaction_survey_question_5_choice_4"),
                t("templates.facilities_satisfaction_survey_question_5_choice_5"),
                t("templates.facilities_satisfaction_survey_question_5_choice_6"),
              ],
              headline: t("templates.facilities_satisfaction_survey_question_5_headline"),
              required: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.facilities_satisfaction_survey_question_6_headline"),
              required: false,
              placeholder: t("templates.facilities_satisfaction_survey_question_6_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const digitalExperienceSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.digital_experience_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.digital_experience_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.digital_experience_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.digital_experience_survey_question_1_lower_label"),
              upperLabel: t("templates.digital_experience_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.digital_experience_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.digital_experience_survey_question_2_lower_label"),
              upperLabel: t("templates.digital_experience_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.digital_experience_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.digital_experience_survey_question_3_lower_label"),
              upperLabel: t("templates.digital_experience_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.digital_experience_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.digital_experience_survey_question_4_lower_label"),
              upperLabel: t("templates.digital_experience_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              ...
              shuffleOption: "none",
              choices: [
                t("templates.digital_experience_survey_question_5_choice_1"),
                t("templates.digital_experience_survey_question_5_choice_2"),
                t("templates.digital_experience_survey_question_5_choice_3"),
                t("templates.digital_experience_survey_question_5_choice_4"),
                t("templates.digital_experience_survey_question_5_choice_5"),
                t("templates.digital_experience_survey_question_5_choice_6"),
              ],
              headline: t("templates.digital_experience_survey_question_5_headline"),
              required: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.digital_experience_survey_question_6_headline"),
              required: false,
              placeholder: t("templates.digital_experience_survey_question_6_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const itServiceSatisfactionSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.it_service_satisfaction_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.it_service_satisfaction_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.it_service_satisfaction_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.it_service_satisfaction_survey_question_1_lower_label"),
              upperLabel: t("templates.it_service_satisfaction_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.it_service_satisfaction_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.it_service_satisfaction_survey_question_2_lower_label"),
              upperLabel: t("templates.it_service_satisfaction_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.it_service_satisfaction_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.it_service_satisfaction_survey_question_3_lower_label"),
              upperLabel: t("templates.it_service_satisfaction_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "star",
              headline: t("templates.it_service_satisfaction_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.it_service_satisfaction_survey_question_4_lower_label"),
              upperLabel: t("templates.it_service_satisfaction_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.it_service_satisfaction_survey_question_5_headline"),
              required: false,
              placeholder: t("templates.it_service_satisfaction_survey_question_5_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const communicationEffectivenessSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.communication_effectiveness_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.communication_effectiveness_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.communication_effectiveness_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.communication_effectiveness_survey_question_1_lower_label"),
              upperLabel: t("templates.communication_effectiveness_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.communication_effectiveness_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.communication_effectiveness_survey_question_2_lower_label"),
              upperLabel: t("templates.communication_effectiveness_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.communication_effectiveness_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.communication_effectiveness_survey_question_3_lower_label"),
              upperLabel: t("templates.communication_effectiveness_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.communication_effectiveness_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.communication_effectiveness_survey_question_4_lower_label"),
              upperLabel: t("templates.communication_effectiveness_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              ...
              shuffleOption: "none",
              choices: [
                t("templates.communication_effectiveness_survey_question_5_choice_1"),
                t("templates.communication_effectiveness_survey_question_5_choice_2"),
                t("templates.communication_effectiveness_survey_question_5_choice_3"),
                t("templates.communication_effectiveness_survey_question_5_choice_4"),
                t("templates.communication_effectiveness_survey_question_5_choice_5"),
                t("templates.communication_effectiveness_survey_question_5_choice_6"),
              ],
              headline: t("templates.communication_effectiveness_survey_question_5_headline"),
              required: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.communication_effectiveness_survey_question_6_headline"),
              required: false,
              placeholder: t("templates.communication_effectiveness_survey_question_6_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const townHallFeedbackSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.town_hall_feedback_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.town_hall_feedback_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.town_hall_feedback_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.town_hall_feedback_survey_question_1_lower_label"),
              upperLabel: t("templates.town_hall_feedback_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.town_hall_feedback_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.town_hall_feedback_survey_question_2_lower_label"),
              upperLabel: t("templates.town_hall_feedback_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.town_hall_feedback_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.town_hall_feedback_survey_question_3_lower_label"),
              upperLabel: t("templates.town_hall_feedback_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "star",
              headline: t("templates.town_hall_feedback_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.town_hall_feedback_survey_question_4_lower_label"),
              upperLabel: t("templates.town_hall_feedback_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.town_hall_feedback_survey_question_5_headline"),
              required: false,
              placeholder: t("templates.town_hall_feedback_survey_question_5_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const executiveCommunicationSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.executive_communication_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.executive_communication_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.executive_communication_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.executive_communication_survey_question_1_lower_label"),
              upperLabel: t("templates.executive_communication_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.executive_communication_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.executive_communication_survey_question_2_lower_label"),
              upperLabel: t("templates.executive_communication_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.executive_communication_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.executive_communication_survey_question_3_lower_label"),
              upperLabel: t("templates.executive_communication_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              ...
              shuffleOption: "none",
              choices: [
                t("templates.executive_communication_survey_question_4_choice_1"),
                t("templates.executive_communication_survey_question_4_choice_2"),
                t("templates.executive_communication_survey_question_4_choice_3"),
                t("templates.executive_communication_survey_question_4_choice_4"),
                t("templates.executive_communication_survey_question_4_choice_5"),
                t("templates.executive_communication_survey_question_4_choice_6"),
              ],
              headline: t("templates.executive_communication_survey_question_4_headline"),
              required: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.executive_communication_survey_question_5_headline"),
              required: false,
              placeholder: t("templates.executive_communication_survey_question_5_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const managerCommunicationSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.manager_communication_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.manager_communication_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.manager_communication_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.manager_communication_survey_question_1_lower_label"),
              upperLabel: t("templates.manager_communication_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.manager_communication_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.manager_communication_survey_question_2_lower_label"),
              upperLabel: t("templates.manager_communication_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.manager_communication_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.manager_communication_survey_question_3_lower_label"),
              upperLabel: t("templates.manager_communication_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.manager_communication_survey_question_4_headline"),
              required: true,
              lowerLabel: t("templates.manager_communication_survey_question_4_lower_label"),
              upperLabel: t("templates.manager_communication_survey_question_4_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.manager_communication_survey_question_5_headline"),
              required: false,
              placeholder: t("templates.manager_communication_survey_question_5_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const crisisCommunicationSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.crisis_communication_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.crisis_communication_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.crisis_communication_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.crisis_communication_survey_question_1_lower_label"),
              upperLabel: t("templates.crisis_communication_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.crisis_communication_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.crisis_communication_survey_question_2_lower_label"),
              upperLabel: t("templates.crisis_communication_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.crisis_communication_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.crisis_communication_survey_question_3_lower_label"),
              upperLabel: t("templates.crisis_communication_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              ...
              shuffleOption: "none",
              choices: [
                t("templates.crisis_communication_survey_question_4_choice_1"),
                t("templates.crisis_communication_survey_question_4_choice_2"),
                t("templates.crisis_communication_survey_question_4_choice_3"),
                t("templates.crisis_communication_survey_question_4_choice_4"),
                t("templates.crisis_communication_survey_question_4_choice_5"),
                t("templates.crisis_communication_survey_question_4_choice_6"),
              ],
              headline: t("templates.crisis_communication_survey_question_4_headline"),
              required: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.crisis_communication_survey_question_5_headline"),
              required: false,
              placeholder: t("templates.crisis_communication_survey_question_5_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
const intranetFeedbackSurvey = (t: TFunction): TTemplate => {
  const localSurvey = getDefaultSurveyPreset(t);
  return buildSurvey(
    {
      name: t("templates.intranet_feedback_survey_name"),
      role: "peopleManager",
      industries: ["saas", "eCommerce", "other"],
      channels: ["link"],
      description: t("templates.intranet_feedback_survey_description"),
      endings: localSurvey.endings,
      hiddenFields: hiddenFieldsDefault,
      blocks: [
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.intranet_feedback_survey_question_1_headline"),
              required: true,
              lowerLabel: t("templates.intranet_feedback_survey_question_1_lower_label"),
              upperLabel: t("templates.intranet_feedback_survey_question_1_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.intranet_feedback_survey_question_2_headline"),
              required: true,
              lowerLabel: t("templates.intranet_feedback_survey_question_2_lower_label"),
              upperLabel: t("templates.intranet_feedback_survey_question_2_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildRatingElement({
              range: 5,
              scale: "number",
              headline: t("templates.intranet_feedback_survey_question_3_headline"),
              required: true,
              lowerLabel: t("templates.intranet_feedback_survey_question_3_lower_label"),
              upperLabel: t("templates.intranet_feedback_survey_question_3_upper_label"),
              isColorCodingEnabled: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildMultipleChoiceElement({
              ...
              shuffleOption: "none",
              choices: [
                t("templates.intranet_feedback_survey_question_4_choice_1"),
                t("templates.intranet_feedback_survey_question_4_choice_2"),
                t("templates.intranet_feedback_survey_question_4_choice_3"),
                t("templates.intranet_feedback_survey_question_4_choice_4"),
                t("templates.intranet_feedback_survey_question_4_choice_5"),
                t("templates.intranet_feedback_survey_question_4_choice_6"),
              ],
              headline: t("templates.intranet_feedback_survey_question_4_headline"),
              required: true,
            }),
          ],
          t,
        ...
        buildBlock({
          ...
          elements: [
            buildOpenTextElement({
              headline: t("templates.intranet_feedback_survey_question_5_headline"),
              required: false,
              placeholder: t("templates.intranet_feedback_survey_question_5_placeholder"),
              inputType: "text",
              longAnswer: true,
            }),
          ],
...
export const templates = (t: TFunction): TTemplate[] => [
  ...
  preboardingSurvey(t),
  dayOneFirstDaySurvey(t),
  onboarding7DaySurvey(t),
  sixMonthNewHireCheckIn(t),
  probationEndSurvey(t),
  anniversarySurvey(t),
  promotionSurvey(t),
  internalTransferSurvey(t),
  returnFromLeaveSurvey(t),
  parentalLeaveSurvey(t),
  alumniSurvey(t),
  ...
  hybridWorkSurvey(t),
  remoteWorkSurvey(t),
  returnToOfficeSurvey(t),
  facilitiesSatisfactionSurvey(t),
  digitalExperienceSurvey(t),
  itServiceSatisfactionSurvey(t),
  communicationEffectivenessSurvey(t),
  townHallFeedbackSurvey(t),
  executiveCommunicationSurvey(t),
  managerCommunicationSurvey(t),
  crisisCommunicationSurvey(t),
  intranetFeedbackSurvey(t),
